  ...
  return (
   <>
    ...
    <img
      ...
      alt=""
      class="w-full h-auto filter blur-sm"
    />
      <div class="absolute inset-0 flex items-center justify-center bg-gray-900 bg-opacity-70 text-white">
        <p class="p-4 md:p-8 lg:p-12 text-3xl md:text-4xl lg:text-5xl font-extrabold text-center leading-snug">
    ...
    <div class="container mx-auto p-7 bg-red-200">
    <h1 class="text-3xl font-bold mb-4">Our Core Pillars</h1>

    <div class="flex flex-wrap">
      <div class="w-full md:w-1/2 lg:w-1/3 p-20 bg-red-300">
        <h2 class="text-xl font-bold">Quality Equipment and Tools:</h2>
      ...
      <div class="w-full md:w-1/2 lg:w-1/3 p-20 mt-4 md:mt-0 bg-red-400">
        <h2 class="text-xl font-bold">Availability and Accessibility:</h2>
